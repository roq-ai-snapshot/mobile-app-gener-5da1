...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`mobile app generation application`}</title>

        <meta
          name="description"
          content="Experience the future of development with Mobile App Generation Application, a platform designed to transform your ideas into reality. Unleash your creativity, build your vision."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1601972602237-8c79241e468b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHB8ZW58MHx8fHwxNjk2OTQyNjg2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`mobile app generation application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of development with Mobile App Generation Application, a platform designed to transform your ideas into reality. Unleash your creativity, build your vision.`}
            </Text>
            <Box
