...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'owner', 'team-member', 'collaborator', 'end-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Apps', path: '/apps', entity: 'app', service: AccessServiceEnum.PROJECT, icon: FiSmartphone },
    { name: 'Bugs', path: '/bugs', entity: 'bug', service: AccessServiceEnum.PROJECT, icon: FiAlertCircle },
    { name: 'Features', path: '/features', entity: 'feature', service: AccessServiceEnum.PROJECT, icon: FiStar },
    {
      name: 'Test Cases',
      path: '/test-cases',
      entity: 'test_case',
